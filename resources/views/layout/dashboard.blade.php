            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            <a href="/data-user"><i class="fas fa-money-bill"></i><span>Data Pengguna</span></a>
                        </li>
                        @endif
                        @if (Auth::user()->role != 'user')
                        <li class="nav-item dropdown">
                            <a href="/kategori-buku"><i class="fas fa-money-bill"></i><span>Kategori Buku</span></a>
                        </li>
                        @endif
                        <li class="nav-item dropdown">
                            <a href="/pendataan-buku"><i class="fas fa-money-bill"></i><span>Buku</span></a>
                        </li>
                        <li class="nav-item dropdown">
                            <a href="/data-peminjaman-buku"><i class="fas fa-money-bill"></i><span>Riwayat Peminjaman</span></a>
                        </li>
                        @if (Auth::user()->role == 'user')
                        <li class="nav-item dropdown">
                            <a href="/koleksi-buku"><i class="fas fa-money-bill"></i><span>Koleksi Buku</span></a>
                        </li>
                        @endif
                    </ul>
                </aside>
